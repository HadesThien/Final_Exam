...
namespace CustomControls.RJControls
{
    public class RJDatePicker : DateTimePicker
    {
        ...
        private Image calendarIcon = Final_Exam.Properties.Resources.calendarWhite;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.6F)
                    calendarIcon = Final_Exam.Properties.Resources.calendarDark;
                else calendarIcon = Final_Exam.Properties.Resources.calendarWhite;
                this.Invalidate();
            }
        }
